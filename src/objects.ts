...
export function toShortForm(question: Question): string {
    let shortened: string = question.id.toString() + ": ";
    shortened = shortened + question.name.slice(0, 10);
    return shortened;
}
...
export function toMarkdown(question: Question): string {
    ...
    if (question.type === "multiple_choice_question") {
        output = output + "\n";
        output = output + "- " + question.options[0] + "\n";
        output = output + "- " + question.options[1] + "\n";
        output = output + "- " + question.options[2];
    }
